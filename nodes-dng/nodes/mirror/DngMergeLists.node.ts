...
export class DngMergeLists implements INodeType {
  description: INodeTypeDescription = {
    displayName: "Merge_Lists",
    name: "dngMergeLists",
    group: ['transform'],
    version: 1,
    defaults: { name: "Merge_Lists" },
    description: "Merge multiple lists",
    inputs: [NodeConnectionType.Main],
    outputs: [NodeConnectionType.Main],
    properties: [
      { displayName: "DNG", name: "dngNotice", type: "notice", default: "DNG label: Merge_Lists" }
    ],
  };
